...
| 2026-08-19 | Phase 6 recovery log analysis | Windows/Python 3 | JSONL event 검증, EIO·retry 횟수, 최초 오류·복구 시각과 latency, event count/within assertion 검증; 전체 100개 테스트 통과 | `issue-1/recovery-report`, `src/vdevlab/analysis.py` |
